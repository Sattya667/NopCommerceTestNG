...
public class AddcustomerPage {
    ...
    By expandArrowCustomers = By.xpath("//a[@class='nav-link']//p[contains(text(),'Customers')]//i[@class='right fas fa-angle-left ']");
    ...
    public void clickOnCustomersMenu() {
        ldriver.findElement(expandArrowCustomers).click();
    }
